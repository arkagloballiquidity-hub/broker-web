...
const data: MarketData = {
  ...
  description:
    "8 CFDs de fondos cotizados en bolsa que cubren acciones, materias primas y estrategias apalancadas. Comisión cero en cuentas STD.",
  conditions: [
...
export default function EsETFsPage() {
